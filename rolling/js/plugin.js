...
! function(a) {
  a.fn.gMap = function(b, c) {
    ...
    return this.each(function() {
      ...
      }) : b.setCenter(new google.maps.LatLng(d.markers[0].latitude, d.markers[0].longitude)) : b.setCenter(new google.maps.LatLng(18.7561133,99.0153202)), b.setZoom(d.zoom), b.setMapTypeId(google.maps.MapTypeId[d.maptype]);
      var e = {
